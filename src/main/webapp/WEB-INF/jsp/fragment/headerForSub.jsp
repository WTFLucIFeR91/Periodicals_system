              ...
              <div class="container-xl">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample02">
                  <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link disabled" aria-current="page" href="controller?command=showSubscriptions"><fmt:message key='Subscriptions'/></a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group me-2" role="group" aria-label="First group">
                      <form class="d-flex" role="search" style="margin-top: 15px;" action="controller" method="get">
                        <input class="form-control me-2 disabled" type="search" placeholder="<fmt:message key='Search'/>" name="search" required disabled/>
                    ...
                    <div class="btn-group me-2" role="group" aria-label="Second group">
                      <ul class="navbar-nav me-auto">
		                 <li class="nav-item">
                           <a class="nav-link active" style="margin-top: 15px;" aria-current="page" href="controller?command=showSubscriptions&sessionLocale=uk">UA</a>
                         </li>
                         <li class="nav-item">
                           <a class="nav-link active" style="margin-top: 15px;" aria-current="page" href="controller?command=showSubscriptions&sessionLocale=en">EN</a>
                         </li>
                      </ul>
                    <div>
