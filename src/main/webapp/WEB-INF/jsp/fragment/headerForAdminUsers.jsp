              ...
              <div class="container-xl">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample02">
                  <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link disabled" href="controller?command=showUsers"><fmt:message key='Users'/></a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                    ...
                    <div class="btn-group me-2" role="group" aria-label="Second group">
                      <ul class="navbar-nav me-auto">
		                 <li class="nav-item">
                           <a class="nav-link active" style="margin-top: 15px;" aria-current="page" href="controller?command=showUsers&sessionLocale=uk">UA</a>
                         </li>
                         <li class="nav-item">
                           <a class="nav-link active" style="margin-top: 15px;" aria-current="page" href="controller?command=showUsers&sessionLocale=en">EN</a>
                         </li>
                      </ul>
                    <div>
