                        ...
                        <div class="d-flex flex-column" style="height: 100%">
                          <div class="d-flex justify-content-center">
                            ...
                            <form class="sub1" action="controller"  method="get">
                                ...
                                <input type="hidden" name="publicationIndex" value="${pub.index}"/>
                                <input class="btn btn-warning btn--small btn-warning"  type="submit" value="<fmt:message key='Edit'/>">
                            </form>
                            <form class="sub1" action="controller"  method="get">
                                <input type="hidden" name="command" value="deletePeriodical"/>
                                <input type="hidden" name="publicationIndex" value="${pub.index}"/>
                                <input class="btn btn-warning btn--small btn-warning"  type="submit" value="<fmt:message key='Remove'/>">
                            </form>
                        </div>
                      </div>
                      </c:forEach>
